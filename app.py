...
def render_home_page():
    ...
    st.markdown(
        ...
        - **근로계약서**: 근로계약서를 작성하고 HTML로 다운로드합니다.
        - **임금대장**: 직원 정보와 임금 지급 기록을 관리합니다.
        - **임금명세서**: 임금명세서를 생성하고 HTML로 다운로드합니다.
        """
    )
    ...
    st.info(
        """
        - HTML 문서는 웹 브라우저에서 열어 인쇄하거나 이메일로 전송할 수 있습니다.
        - 근로계약서와 임금명세서에는 인쇄하기 버튼이 있어 편리하게 출력할 수 있습니다.
        - 정기적으로 생성된 문서를 백업하는 것을 권장합니다.
        """
    )
